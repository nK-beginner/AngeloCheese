                ...
                <form method="POST" class="product-form" enctype="multipart/form-data">
                    <div class="product-info">
                        <div class="form-block">
                            <div class="block">
                                <h3>商品表示状態</h3>
                                <label class="user-radio"><input type="radio" value="on"  id="on"  name="display" <?php if($editItem['hidden_at'] === NULL) echo 'checked'; ?> >表示</label>
                                <label class="user-radio"><input type="radio" value="off" id="off" name="display" <?php if($editItem['hidden_at'] !== NULL) echo 'checked'; ?> >非表示</label>
                            </div>
                            <div class="block">
                                <h3>メイン画像</h3>
                        ...
                        <div class="form-block">
                            <div class="block">
                                <h3>商品名</h3>
                                <input type="text" class="user-input" name="name" placeholder="例：チーズケーキサンド" value="<?php echo htmlspecialchars($editItem['name'], ENT_QUOTES, 'UTF-8'); ?>">
                            </div>
                            <div class="block">
                                <h3>商品説明</h3>
                                <textarea class="user-input" name="description"><?php echo htmlspecialchars($editItem['description'], ENT_QUOTES, 'UTF-8'); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="grid-block">
                            <div class="form-block">
                                ...
                                <div class="block">
                                    <h3>キーワード</h3>
                                    <input type="text" class="user-input" name="keyword" placeholder="例：北海道産" value="<?php echo htmlspecialchars($editItem['keyword'], ENT_QUOTES, 'UTF-8'); ?>">                       
                                </div>
                            </div>
                            ...
                            <div class="form-block">
                                <div class="block">
                                    <h3>サイズ(cm)</h3>
                                    <div class="sub-block">
                                        <input type="text" class="user-input" name="size1" inputmode="numeric" placeholder="例：15" maxlength="3" value="<?php echo htmlspecialchars($editItem['size1'], ENT_QUOTES, 'UTF-8'); ?>">
                                        <p>✖</p>
                                        <input type="text" class="user-input" name="size2" inputmode="numeric" placeholder="例：15" maxlength="3" value="<?php echo htmlspecialchars($editItem['size2'], ENT_QUOTES, 'UTF-8'); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-block">
                            <div class="block">
                                <h3>税率</h3>
                                <div class="sub-block">
                                    <label class="user-radio"><input type="radio" value="0.1"  pattern="\d*" name="tax-rate" <?php if($editItem['tax_rate'] == '0.10') echo 'checked'; ?> >10%</label>
                                    <label class="user-radio"><input type="radio" value="0.08" pattern="\d*" name="tax-rate" <?php if($editItem['tax_rate'] == '0.08') echo 'checked'; ?> >8%</label>
                                </div>
                            </div>
